...
export default function Index() {
  ...
  return (
    <div className="min-h-screen pb-20" style={{ backgroundColor: "#FFF8F2" }}>
      ...
      {showCheckout && (
        <CheckoutModal total={total} onClose={() => setShowCheckout(false)} onConfirm={() => {
...
<dyad-write path="src/pages/Index.tsx" description="Update RecipeCard usage to pass the whole recipe object">
"use client";
import { useState } from "react";
import { Header } from "@/components/Header";
import { GamificationBar } from "@/components/GamificationBar";
