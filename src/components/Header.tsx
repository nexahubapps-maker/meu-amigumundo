...
export const Header = ({ cartCount = 0 }: HeaderProps) => {
  ...
  return (
    <div className="sticky top-3 z-50 mx-4 my-2 bg-white h-[110px] flex items-center px-4 shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-2xl border border-gray-100/80">
      <div className="w-full flex items-center justify-between">
        ...
        >
          ...
          />
          <span className="text-[10px] font-black text-black mt-0.5 leading-none">
        ...
        <div className="flex flex-col items-center gap-1.5 shrink-0">
          ...
          {/* Cart button positioned below the badge */}
          <button 
